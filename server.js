...
const GENRE_KB = {
  ...
  "mandopop":   "tempo ballad 62-80 / mid 90-110; chords: 4536 progression IV-V-iii-vi (F-G-Em-Am in C; same harmony as the Japanese royal road), plus Canon-family 15634125 ballad lines, final-chorus key lift; instruments: piano-driven with string pads, melodic guitar counter-lines, soft kit entering at chorus; vocal: breathy intimate Mandarin verse rising to soaring belted chorus, tasteful runs; production: lush wide chorus, vocal-forward KTV-ready mix",
  ...
  "soul":       "ERA ANCHOR: default to late-1960s/70s soul production; tempo 60-75 slow or 100-120 Motown; chords: doo-wop I-vi-IV-V motion, gospel-tinged IV-iv passing chords; instruments: warm live rhythm section, Motown bass lines, horn section stabs, tremolo guitar, tambourine on backbeat; vocal: impassioned raspy-to-smooth lead, church-style runs, BGV answers; production: analog tape warmth, live room glue; EXCLUDE: 808 sub bass, EDM elements",
  ...
  "j-pop":      "tempo ballad 70-85 / standard 110-130; chords: royal road IV-V-iii-vi (known as 4536 in Chinese pop) and Komuro vi-IV-V-I progressions, frequent modulation; instruments: bright piano and strings over tight band, energetic clean guitars, colorful synth touches; vocal: clear emotive Japanese lead, harmonized hooks; form: A-melo B-melo sabi build with last-chorus key change; production: dense but clean arrangement, polished sheen",
  "cantopop":   "tempo ballad 65-80 / mid 95-110; chords: 4536 (IV-V-iii-vi) and Canon 15634125 progressions, final-chorus key lift; instruments: piano-led with lush strings, clean guitar arpeggios, restrained drums entering at chorus; vocal: expressive Cantonese lead — lyrics MUST follow 協音 tone-melody matching; production: HK studio polish, vocal-forward ballad mix",
